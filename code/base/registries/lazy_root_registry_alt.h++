...
#ifndef THESIS_LAZY_ROOT_REGISTRY_ALT
#define THESIS_LAZY_ROOT_REGISTRY_ALT
#include <memory>
#include <utility>
  ...
  namespace thesis  {
    namespace root_registry  {
      ...
      public:
        ...
        explicit lazy_root_registry_alt( );
        ~lazy_root_registry_alt( ); 
...
#include "lazy_root_registry_alt.i++"
#endif
